...
import ratePreceptor from "../../actions/rate-preceptor";
...
export default function AddReviewModal({ preceptorId }: AddReviewModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const success = await ratePreceptor({
        preceptorId,
        rating,
        note: note.trim(),
      });
    ...
    <Dialog open={open} onOpenChange={(newOpen) => {
      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Share your experience with this preceptor
          </DialogDescription>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              disabled={isSubmitting}
              rows={4}
              placeholder="Share your experience with this preceptor..."
            />
          </div>
